...
const allActionsSample = [
  {
    ...
    action: () => console.log("Book tickets action")
  },
  {
    id: "2",
    label: "Summarize",
  ...
  },
  {
    ...
    action: () => console.log("Screen Studio action")
  },
  {
    id: "4",
    ...
    action: () => console.log("Talk to Jarvis action")
  },
  {
    id: "5",
    ...
    action: () => window.open("https://kokonutui.com", "_blank")
  },
]
        ...
        <div className="w-full max-w-sm">
          <AnimatePresence>
            {isFocused && result && !selectedAction && (
              <motion.div
                className="w-full border border-border rounded-md shadow-xs overflow-hidden bg-background mt-1"
                ...
                <motion.ul role="none">
                  {result.actions.map((action) => (
                    <motion.li
                      key={action.id}
                      id={`action-${action.id}`}
                      className={`px-3 py-2 flex items-center justify-between hover:bg-muted cursor-pointer rounded-md ${
